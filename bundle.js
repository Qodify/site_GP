...
var app = (function () {
    ...
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(23:6) <Link BSclass=\\\"nav-link\\\" to=\\\"/\\\">",
    		ctx
    	});
    ...
    // (26:6) <Link BSclass="nav-link" to="/blog">
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(26:6) <Link BSclass=\\\"nav-link\\\" to=\\\"/blog\\\">",
    		ctx
    	});
    ...
    // (29:6) <Link BSclass="nav-link" to="/contact">
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:6) <Link BSclass=\\\"nav-link\\\" to=\\\"/contact\\\">",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li1, file$1, 24, 4, 521);
    			attr_dev(li2, "class", "nav-item px-3");
    			add_location(li2, file$1, 27, 4, 619);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$2, 3, 4, 68);
    			add_location(p0, file$2, 4, 4, 86);
    			add_location(p1, file$2, 14, 4, 693);
    			add_location(br, file$2, 15, 4, 724);
    			add_location(p2, file$2, 16, 4, 736);
    			attr_dev(div0, "class", "col-12");
    			add_location(div0, file$2, 1, 2, 40);
    			attr_dev(div1, "class", "container mx-auto mt-4");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 23, 0, 598);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	let t1;
    	let h6;
    	let t2_value = new Date(/*post*/ ctx[0].timestamp).toLocaleDateString(undefined, /*options*/ ctx[1]) + "";
    	let t2;
    	let t3;
    	let p;
    	let t4_value = /*post*/ ctx[0].body + "";
    	let t4;
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			add_location(h5, file$4, 19, 6, 578);
    			attr_dev(h6, "class", "mb-2 text-muted");
    			add_location(h6, file$4, 20, 6, 607);
    			attr_dev(p, "class", "");
    			add_location(p, file$4, 23, 6, 731);
    			attr_dev(div, "class", "col-8 mx-auto");
    			add_location(div, file$4, 18, 4, 543);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, h5);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*post*/ 1 && t2_value !== (t2_value = new Date(/*post*/ ctx[0].timestamp).toLocaleDateString(undefined, /*options*/ ctx[1]) + "")) set_data_dev(t2, t2_value);
    			if (dirty & /*post*/ 1 && t4_value !== (t4_value = /*post*/ ctx[0].body + "")) set_data_dev(t4, t4_value);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    		}
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$4, 16, 0, 494);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "alert alert-warning mb-0");
    			attr_dev(div, "role", "alert");
    			add_location(div, file$5, 20, 2, 459);
    			add_location(body, file$5, 19, 0, 450);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
